    ...
    <div className="flex flex-col gap-5 p-4 animate-fade-in pb-10">
      ...
      <div className="flex justify-between items-center bg-white p-3 rounded-2xl border border-slate-200/80 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div className="grid grid-cols-2 gap-[2px] p-1.5 bg-slate-900 rounded-lg select-none">
          ...
          <div className="flex flex-col leading-none">
            <span className="text-[8px] font-bold text-slate-500 mb-0.5 tracking-wider uppercase">HANOI AMIGOS CAMP ×</span>
            <span className="text-[12px] font-black tracking-tight text-slate-800">VIETKAO⁺</span>
        ...
        <div className="flex items-center gap-2">
          {onResetRegistration && (
            <button
              ...
              className="p-1.5 bg-slate-100 hover:bg-slate-200 hover:text-rose-600 rounded-lg text-slate-500 transition-colors"
            >
              <RotateCcw size={14} />
            </button>
          )}
          <div className="relative">
            ...
            />
            <span className="absolute bottom-0 right-0 w-3 h-3 bg-emerald-500 rounded-full border-2 border-slate-50"></span>
          </div>
        </div>
      </div>
      ...
      {/* Status Badge */}
      <div className="bg-amber-50 border border-amber-250 rounded-2xl p-3.5 flex items-start gap-3">
        <div className="p-1.5 bg-amber-100 rounded-lg text-amber-600 mt-0.5">
          <Star size={16} fill="currentColor" />
        </div>
        <div className="flex flex-col gap-0.5">
          <span className="text-xs font-bold text-amber-800">Đánh giá thể trạng từ Bác sĩ:</span>
      ...
      <div className="flex justify-between items-center px-1">
        <h3 className="text-xs font-bold text-slate-500 tracking-wider uppercase">Chỉ số sức khỏe hiện tại</h3>
      ...
      <div className="grid grid-cols-2 gap-4">
        {/* Height Metric */}
        <div className="bg-white border border-slate-200/80 rounded-2xl p-4 flex flex-col justify-between h-[115px] relative group hover:border-vietkao/40 transition-colors shadow-sm">
          <div className="flex justify-between items-start">
          ...
          <div>
            <div className="text-xl font-extrabold text-slate-800 flex items-baseline gap-1">
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-4 flex flex-col justify-between h-[115px] relative group hover:border-vietkao/40 transition-colors shadow-sm">
          <div className="flex justify-between items-start">
            <span className="text-xs font-bold text-slate-500">Cân nặng</span>
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-4 flex flex-col justify-between h-[115px] relative group hover:border-vietkao/40 transition-colors shadow-sm">
          <div className="flex justify-between items-start">
            <span className="text-xs font-bold text-slate-500">Khối cơ xương (SMM)</span>
          ...
          <div>
            ...
            <div className="text-[10px] text-emerald-600 font-medium bg-emerald-500/5 px-2 py-0.5 rounded-full w-max text-[9px]">
              Tập trung tăng cơ
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-4 flex flex-col justify-between h-[115px] relative group hover:border-vietkao/40 transition-colors shadow-sm">
          <div className="flex justify-between items-start">
            <span className="text-xs font-bold text-slate-500">Tỷ lệ mỡ (PBF)</span>
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl p-4 flex flex-col gap-2 shadow-sm">
        <div className="flex justify-between items-center text-xs">
          <span className="font-bold text-slate-700">Năng lượng khuyến nghị hàng ngày</span>
        ...
        <div className="flex justify-between items-center text-[11px] text-slate-600 font-semibold mt-1">
          <span>Calo đã nạp hôm nay:</span>
          <span className="text-amber-600">{caloriesConsumed}/{caloriesTarget} Kcal</span>
        </div>
        ...
        <button
          ...
          className="mt-2 w-full bg-slate-100 hover:bg-slate-200 text-vietkao font-bold py-2 px-3 rounded-xl transition-all flex items-center justify-center gap-1.5 text-xs border border-slate-200 shadow-xs"
        >
      ...
      {showMealLogger && (
        <div className="absolute inset-0 bg-black/60 z-50 animate-fade-in flex flex-col justify-end">
          ...
          <div className="bg-white border-t border-slate-200 rounded-t-[32px] p-5 pb-8 animate-slide-up flex flex-col gap-4 max-h-[450px]">
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              <div className="flex items-center gap-2 text-vietkao">
                <Utensils size={18} />
                <h4 className="text-xs font-bold text-slate-800 uppercase tracking-wider">Báo cáo bữa ăn (Món ăn)</h4>
              </div>
              <button 
            ...
            <p className="text-[10px] text-slate-500">Chọn món ăn bạn đã sử dụng để cập nhật lượng Calorie tiêu thụ hôm nay:</p>
            ...
            <div className="grid grid-cols-2 gap-3 overflow-y-auto no-scrollbar max-h-[260px] py-1">
              {PREDEFINED_FOODS.map((food, idx) => (
                <button
                  ...
                  className="bg-slate-50 border border-slate-200 hover:border-vietkao/50 rounded-2xl p-3 flex flex-col items-center gap-1.5 text-center transition-all active:scale-95 group shadow-xs"
                >
                  ...
                  <span className="text-[10px] text-amber-600 font-bold bg-amber-500/10 px-2 py-0.5 rounded-full">+{food.calories} Kcal</span>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl flex flex-col max-h-[85%]">
            ...
            <div className="bg-slate-50 px-4 py-3 border-b border-slate-200 flex justify-between items-center">
              <div className="flex items-center gap-2 text-emerald-600">
                <BookOpen size={18} />
                <h4 className="text-xs font-bold text-slate-800 uppercase tracking-wider">Khảo sát kiến thức</h4>
              </div>
              <button 
            ...
            <div className="p-4 overflow-y-auto no-scrollbar flex-1 text-xs">
              {!quizCompleted ? (
                <div className="space-y-5">
                  <p className="text-[11px] text-slate-500 italic">Hãy chọn câu trả lời đúng cho các câu hỏi sau để kiểm tra mức độ hiểu biết dinh dưỡng của bạn.</p>
                        ...
                        <button
                          ...
                          className={`w-full text-left p-3 rounded-xl border transition-all text-[11px] ${
                            quizAnswers.q1 === opt.value
                              ? 'bg-emerald-50 border-emerald-600 text-white font-bold'
                        ...
                        <button
                          ...
                          className={`w-full text-left p-3 rounded-xl border transition-all text-[11px] ${
                            quizAnswers.q2 === opt.value
                              ? 'bg-emerald-550 border-emerald-600 text-white font-bold'
                              : 'bg-slate-50 border-slate-200 text-slate-700 hover:border-slate-350'
                          }`}
                        >
                          {opt.label}
                ...
                <div className="text-center py-6 flex flex-col items-center justify-center gap-4">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-slate-800">Kết Quả Khảo Sát</h3>
                    <p className="text-[10px] text-slate-500 mt-0.5">Hoàn thành bài đánh giá kiến thức</p>
                  </div>

                  <div className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-4 text-left space-y-3 mt-2">
                    <div>
                      <p className="font-bold text-slate-800 text-[10px]">Câu 1: Cơ thể người có bao nhiêu phần trăm là nước?</p>
                      <div className="flex justify-between items-center mt-1 text-[11px]">
                        <span className={quizAnswers.q1 === 'C' ? 'text-emerald-600 font-bold' : 'text-rose-600'}>
                    ...
                    <div className="border-t border-slate-200 pt-2">
                      <p className="font-bold text-slate-800 text-[10px]">Câu 2: Dưỡng chất xây dựng cơ bắp?</p>
                      <div className="flex justify-between items-center mt-1 text-[11px]">
                        <span className={quizAnswers.q2 === 'B' ? 'text-emerald-600 font-bold' : 'text-rose-600'}>
                  ...
                  <button
                    onClick={() => setShowQuizModal(false)}
                    className="w-full bg-slate-100 border border-slate-200 hover:bg-slate-200 text-slate-800 font-bold py-2.5 rounded-xl transition-all mt-4"
                  >
                    Đóng
                  </button>
                </div>
